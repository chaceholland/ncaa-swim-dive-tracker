...
function decodeImgproxyUrl(imgproxyUrl) {
  ...
  // Pattern: /imgproxy/.../ce/0/{base64}.png or similar
...
async function main() {
  console.log('\n🔧 FIXING KENTUCKY HEADSHOTS - DECODING IMGPROXY URLS');
  ...
  // Get Kentucky athletes with imgproxy URLs
  ...
  console.log(`Found ${athletes.length} Kentucky athletes with imgproxy URLs\n`);
  ...
  console.log('✅ KENTUCKY IMGPROXY DECODE COMPLETE');
  console.log('='.repeat(70));
